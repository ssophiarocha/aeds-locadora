...
void cadastracliente()
{
    ...
    if (arqClientes != NULL)
    {
        ...
        {
           fprintf(arqClientes,"\nInicio cliente\n");
           fprintf(arqClientes,"--Codigo: %i",vetClientes[j].codigo);
           fprintf(arqClientes,"--Nome: %s\n",vetClientes[j].nome);
           fprintf(arqClientes,"--CNH: %s\n",vetClientes[j].cnh);
           fprintf(arqClientes,"--Celular: %s\n",vetClientes[j].telefone);
           fprintf(arqClientes,"--Endereco: %s\n",vetClientes[j].endereco);
        }
        j = j + 1;
        vetClientes[j].codigo = 999;
        fclose(arqClientes);
